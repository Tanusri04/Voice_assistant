...
def say_hello(text):
    greet = ["hi", "hey", "hola", "greetings", "hello", "wwhat's good", "hey there"]

    response = ["whats good", "hello", "hey there"]
    ...
    try:
        ...
        if call(text):
            ...
            if "date" in text or "day" in text or "month" in text:
                ...
                key = "bddc33ad94e4809b84b90b2983f84891"
                ...
                speak = speak + "I was created by Team Assistify"
                ...
                if "chrome" in text.lower():
                    ...
                    os.startfile(
                        r"C:\Users\Tanusri.DESKTOP-LLOE865\AppData\Local\Programs\Microsoft VS Code\Code.exe"
                    )
                ...
                url = (
                    ...
                    "country=in&"
                    "apiKey=4a821cb245a2425888875f926646a852"
                )
